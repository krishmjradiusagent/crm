...
(function(){
  ...
  const melmark = '<img src="' + window.__resources.melIcon + '" alt="" class="melmark">';
  ...
  const tplThumb = k => '<img class="wbthumbimg" src="' + window.__resources['tpl_' + k] + '" alt="' + esc(TPL[k].n) + ' template">';
  const COLORS = [
  ...
  const PROPIMG = [window.__resources.prop1, window.__resources.prop2, window.__resources.prop3, window.__resources.prop4];
